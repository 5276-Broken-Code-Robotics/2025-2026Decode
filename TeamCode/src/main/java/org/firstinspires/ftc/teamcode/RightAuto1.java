...
public class RightAuto1 extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(132, 84, Math.toRadians(0)); // Highest (First Set) of Artifacts from the Spike Mark.
    private final Pose pickup2Pose = new Pose(132, 60, Math.toRadians(0)); // Middle (Second Set) of Artifacts from the Spike Mark.
    private final Pose pickup3Pose = new Pose(132, 36, Math.toRadians(0)); // Lowest (Third Set) of Artifacts from the Spike Mark.
    ...
    private final Pose finalPose = new Pose(96, 72, Math.toRadians(90)); // Lowest (Third Set) of Artifacts from the Spike Mark.
